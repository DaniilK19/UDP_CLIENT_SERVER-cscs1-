...
class Program
{
    ...
    static void SendCommand(UdpClient udpClient, IPEndPoint serverEndPoint, string commandToSend)
    {
        try
        {
    ...
    static void SendClearDisplayCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
    ...
    static void SendDrawPixelCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
    ...
    static void SendDrawLineCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendDrawRectangleCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendFillRectangleCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendDrawEllipseCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendFillEllipseCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendDrawCircleCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendFillCircleCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendDrawRoundedRectangleCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendFillRoundedRectangleCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendDrawTextCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendDrawImageCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть x0: ");
        int x0 = GetUserInputInt();
        Console.Write("Введіть y0: ");
    ...
    static void SendSetOrientationCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
    ...
    static void SendGetWidthCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть ширіну: "); // Виправлено на "ширіну"
    ...
    static void SendGetHeightCommand(UdpClient udpClient, IPEndPoint serverEndPoint)
    {
        Console.Write("Введіть висоту: ");
